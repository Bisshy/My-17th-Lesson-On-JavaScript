...
// function repeat(start, stop, action){
//     for(let i = start; i < stop; i++){
//         action(i);
//     }
// }
// repeat(0, 3, console.log);
...
// let greaterThan10 = greaterThan(6);
...
//         let result = f(...args);
//         console.log(`calling with`, args, " retuned", result);
//         return result;
...
//     return passed;
// }
// console.log(filter(SCRIPTS, script => script.direction == "ltr"));
